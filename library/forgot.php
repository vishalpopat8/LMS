...
<body>
    <div class="wrapper">
        ...
        <form action="" method="post">
            <b><p style="text-align: center;">Reset Password for:</p></b>
            <div style="display: flex;justify-content: center;" class="input-group mb-3">


                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" class="custom-control-input" id="defaultUnChecked" name="login" value="student" required="">
                    <label class="custom-control-label"  for="defaultUnChecked">Student</label>
                </div>

                <!-- Default unchecked -->
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" class="custom-control-input" id="defaultUnchecked" name="login" value="admin" required="">
...
else
{
    ...
    $_SESSION['un']=$_POST['username'];
    $_SESSION['em']=$_POST['email'];
    $u = mysqli_query($db, "SELECT * FROM admin WHERE username='$_POST[username]' AND email='$_POST[email]' AND status='yes';");
    $r = mysqli_fetch_array($u);
    if (isset($r['username']) == $_POST['username'] && isset($r['email']) == $_POST['email']) {
...
if (isset($_POST['update'])) {
    ...
    if ($_POST['newpass'] == $_POST['conpass'] && $_POST['otp'] == $r2['otp']) {
        ...
        if($_SESSION['log']=='admin')
        {
            $v=mysqli_query($db, "UPDATE admin SET password='$_POST[newpass]' WHERE username='$_SESSION[un]'");
        }
        if ($v) {
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button name="ok" type="button" class="btn btn-primary"><a style="text-decoration: none;color: white;" href="login.php">Login</a></button>
