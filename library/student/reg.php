    ...
    <section>
        ...
        <div class="stu_reg">
            ...
            <div class="box2">
                ...
                <h1 style="text-align: center;font-size: 35px">Student Registration</h1><br>
                <form name="reg" action="" method="post" style="text-align: center;">
                    ...
                    <input class="form-control" style="height: 30px;width: 400px;"  type="text" name="enrol" placeholder="Enrollment No." required><br>
                    <input class="form-control" style="height: 30px;width: 400px;"  type="email" name="email" placeholder="Email" required><br>
                    <input class="form-control" style="height: 30px;width: 400px;"  type="number" name="phone" placeholder="Mobile No." maxlength="10" size="10" required><br>
